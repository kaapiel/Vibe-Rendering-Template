...
enum
{
	...
	IDC_REGISTER_RLM_ERROR_GROUP,
	IDC_REGISTER_RLM_ETHERNET_ID,
	IDC_REGISTER_RLM_MACHINE_NAME,
	IDC_REGISTER_RLM_USER_NAME,
	IDC_REGISTER_RLM_ERRORMESSAGE,
	// Dialogs must come here
	// Dialog definitions of r_register start here
};
...
enum
{
  ...
  IDS_UNKNOWN_RENDERENGINE,
	...
	IDM_A_HQ_OPENGL_DEPTHOFFIELD = 1038947,
