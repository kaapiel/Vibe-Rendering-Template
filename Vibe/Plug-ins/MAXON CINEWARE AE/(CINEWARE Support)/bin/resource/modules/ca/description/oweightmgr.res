CONTAINER Oweightmgr
{
	...
	GROUP ID_CA_WEIGHT_MGR_SPREADSHEET_GROUP
	{
		...
		GROUP ID_CA_WEIGHT_MGR_SPREADSHEET_FILTER_GROUP
		{
			...
			GROUP
			{
				...
				REAL ID_CA_WEIGHT_MGR_SPREADSHEET_FILTER_MIN { UNIT PERCENT; MIN 0.0; MAX 100.0; CUSTOMGUI REALSLIDER;  SCALE_H; }
				REAL ID_CA_WEIGHT_MGR_SPREADSHEET_FILTER_MAX { UNIT PERCENT; MIN 0.0; MAX 100.0; CUSTOMGUI REALSLIDER; SCALE_H; }
			}
	...
	GROUP ID_CA_WEIGHT_MGR_AUTOWEIGHT_GROUP
	{
		...
		LONG ID_CA_WEIGHT_MGR_AUTOWEIGHT_MODE
		{
			CYCLE
			{
				ID_CA_WEIGHT_MGR_AUTOWEIGHT_MODE_DISTANCE;
				ID_CA_WEIGHT_MGR_AUTOWEIGHT_MODE_VISIBLE;
			}
		}
		BOOL ID_CA_WEIGHT_MGR_AUTOWEIGHT_SELECTED_VERTICES { }

		LONG ID_CA_WEIGHT_MGR_AUTOWEIGHT_JOINTS { MIN 1; FIT_H; SCALE_H; }
		BOOL ID_CA_WEIGHT_MGR_AUTOWEIGHT_ALLOW_NULL { }

		REAL ID_CA_WEIGHT_MGR_AUTOWEIGHT_FALLOFF { UNIT PERCENT; MIN 0.0; MAX 100.0; FIT_H; SCALE_H; CUSTOMGUI REALSLIDER; }
		STATICTEXT { JOINENDSCALE; }

		REAL ID_CA_WEIGHT_MGR_AUTOWEIGHT_VISIBILITY_RATIO { UNIT PERCENT; MIN 0.0; MAX 100.0; FIT_H; SCALE_H; CUSTOMGUI REALSLIDER; }
		STATICTEXT { JOINENDSCALE; }

		REAL ID_CA_WEIGHT_MGR_AUTOWEIGHT_DISTANCE_RATIO { UNIT PERCENT; MIN 0.0; MAXSLIDER 100.0; CUSTOMGUI REALSLIDER; SCALE_H; }
		STATICTEXT { JOINENDSCALE; }

		BUTTON ID_CA_WEIGHT_MGR_AUTOWEIGHT { FIT_H; SCALE_H; }
		STATICTEXT { JOINENDSCALE; }
	}
	...
	GROUP ID_CA_WEIGHT_MGR_OPTIONS_GROUP
	{
		...
		STATICTEXT { JOINEND; }
		BOOL ID_CA_WEIGHT_MGR_DISPLAY_EFFECTORS { }
		...
		LONG ID_CA_WEIGHT_MGR_DISPLAY_HUD_MODE
		{
			CYCLE
			{
				ID_CA_WEIGHT_MGR_DISPLAY_HUD_MODE_NONE;
